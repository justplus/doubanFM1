...
namespace doubanFM.Core
{
	...
	public class ConnectionBase
	{
		...
		/// 默认HTTP头：UserAgent
		/// </summary>
        public static string DefaultUserAgent = "Chrome/14.0.835.186 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)";
		/// <summary>
		/// 默认HTTP头：accept
		/// </summary>
		...
		/// 数据保存文件夹
		/// </summary>
		public static readonly string DataFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"JustListen\");
